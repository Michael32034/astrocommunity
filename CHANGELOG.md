...
## [20.0.0](https://github.com/AstroNvim/astrocommunity/compare/v19.0.0...v20.0.0) (2026-02-26)


### ⚠ BREAKING CHANGES

* **overseer-nvim:** Adjust overseer-nvim command to match v2.0 ([#1729](https://github.com/AstroNvim/astrocommunity/issues/1729))
* **vscode-diff-nvim:** Rename plugin to reflect upstream change in name ([#1720](https://github.com/AstroNvim/astrocommunity/issues/1720))
...
* **ai:** add `folke/sidekick.nvim` ([#1660](https://github.com/AstroNvim/astrocommunity/issues/1660)) ([d10c48d](https://github.com/AstroNvim/astrocommunity/commit/d10c48d796e0c9505db9de71714ff047ab7f4367))
...
* **avante-nvim:** add missing keybinds ([#1705](https://github.com/AstroNvim/astrocommunity/issues/1705)) ([123596f](https://github.com/AstroNvim/astrocommunity/commit/123596ffb00b5ca62dd2e50d3f74c44e689c1739))
...
* **colorscheme:** Add Alabaster colorscheme ([#1701](https://github.com/AstroNvim/astrocommunity/issues/1701)) ([2916a11](https://github.com/AstroNvim/astrocommunity/commit/2916a11a79e2063d7abf27c8fe59e3411bb64076))
* **colorscheme:** add DarkLoam theme ([#1718](https://github.com/AstroNvim/astrocommunity/issues/1718)) ([c83e37c](https://github.com/AstroNvim/astrocommunity/commit/c83e37c5bbda319da1275a69b8ad3374650daea7))
* **colorscheme:** add zenbones colorscheme ([#1676](https://github.com/AstroNvim/astrocommunity/issues/1676)) ([46e2253](https://github.com/AstroNvim/astrocommunity/commit/46e2253dd9c792028e5abde7d232994e983f5bdb))
* **completion:** add blink-copilot completion source ([#1710](https://github.com/AstroNvim/astrocommunity/issues/1710)) ([782a4f0](https://github.com/AstroNvim/astrocommunity/commit/782a4f01124450b52cefebb912f59d04b10d104a))
...
* **file-explorer:** add yazi.nvim ([#1706](https://github.com/AstroNvim/astrocommunity/issues/1706)) ([65fcdbe](https://github.com/AstroNvim/astrocommunity/commit/65fcdbeedf18cde23e8a527ca67d10702b9c57ab))
...
* **git:** add vscode-diff.nvim.plugin ([#1704](https://github.com/AstroNvim/astrocommunity/issues/1704)) ([32ea083](https://github.com/AstroNvim/astrocommunity/commit/32ea0830884abf2a5c9c3db98d45f713e163795b))
...
* **helm:** remove prettier & prettierd ([#1621](https://github.com/AstroNvim/astrocommunity/issues/1621)) ([97d0332](https://github.com/AstroNvim/astrocommunity/commit/97d0332680286eb01e4388fd5ddcd9f163ec0089))
...
* **just:** add just-lsp ([#1702](https://github.com/AstroNvim/astrocommunity/issues/1702)) ([03f6c2e](https://github.com/AstroNvim/astrocommunity/commit/03f6c2e878e06a4717fd0a8d3f2b40c3e535e522))
* **laravel:** add `pint` formatter ([#1692](https://github.com/AstroNvim/astrocommunity/issues/1692)) ([1f6bc88](https://github.com/AstroNvim/astrocommunity/commit/1f6bc88b38056dde246edb1684cb309869855b63))
...
* **python:** move base setup to a `base` submodule and allow `python` pack to still deliver a sane default setup ([2adab99](https://github.com/AstroNvim/astrocommunity/commit/2adab99d34f05d281be36db22dc92432a9d270e8))
* **python:** Split python pack into seperate smaller packs ([#1688](https://github.com/AstroNvim/astrocommunity/issues/1688)) ([2adab99](https://github.com/AstroNvim/astrocommunity/commit/2adab99d34f05d281be36db22dc92432a9d270e8))
...
* **svelte:** add 'typescript-svelte-plugin' in vtsls globalPlugins ([#1685](https://github.com/AstroNvim/astrocommunity/issues/1685)) ([aa20d45](https://github.com/AstroNvim/astrocommunity/commit/aa20d45d918ba1bf2c5bd183870e0a1ae3d5e636))
* **test:** add crazy-coverage-nvim plugin ([#1724](https://github.com/AstroNvim/astrocommunity/issues/1724)) ([83ca23d](https://github.com/AstroNvim/astrocommunity/commit/83ca23ddf87da7f6a9fb483762819982d875174b))
* **trouble-nvim:** integrate snacks.nvim picker ([#1679](https://github.com/AstroNvim/astrocommunity/issues/1679)) ([8d028f4](https://github.com/AstroNvim/astrocommunity/commit/8d028f4ff6173240c85765698d7672b7aa0ce30b))
...
* **utility:** add `live-preview.nvim` plugin ([#1714](https://github.com/AstroNvim/astrocommunity/issues/1714)) ([f8db890](https://github.com/AstroNvim/astrocommunity/commit/f8db89021d0e0576bb59139bfb67081844d24c12))
* **utility:** added support for nvzone-menu plugin ([#1691](https://github.com/AstroNvim/astrocommunity/issues/1691)) ([5095951](https://github.com/AstroNvim/astrocommunity/commit/509595120b03291ed8df746f0a26c888d10357e0))
* **vimtex:** add two more which-key descriptions ([d451f1d](https://github.com/AstroNvim/astrocommunity/commit/d451f1d8e90e21c0cad730add858d8f952c66f01))
...
* **ai:** breaking change in opencode to add selection to opencode prompt ([633ae88](https://github.com/AstroNvim/astrocommunity/commit/633ae885ba7e08c11a86dfa058769eb5ee062fb8))
* **ai:** Breaking change in opencode.nvim to add selection to opencode prompt ([#1689](https://github.com/AstroNvim/astrocommunity/issues/1689)) ([633ae88](https://github.com/AstroNvim/astrocommunity/commit/633ae885ba7e08c11a86dfa058769eb5ee062fb8))
...
* **compiler-nvim:** add telescope.nvim to Compiler.nvim dependencies ([#1734](https://github.com/AstroNvim/astrocommunity/issues/1734)) ([998e0d0](https://github.com/AstroNvim/astrocommunity/commit/998e0d0b9d99f27511d8ec353dedc42cd10cf011))
...
* **crazy-coverage-nvim:** update command and key descriptions ([#1726](https://github.com/AstroNvim/astrocommunity/issues/1726)) ([b17ae49](https://github.com/AstroNvim/astrocommunity/commit/b17ae49df79a885486d958dbfbcb3fcbc07dc305))
* **crazy-coverage-nvim:** update command and key descriptions for clarity ([b17ae49](https://github.com/AstroNvim/astrocommunity/commit/b17ae49df79a885486d958dbfbcb3fcbc07dc305))
...
* **full-dadbod:** add mysql and plsql filetypes for completion ([#1709](https://github.com/AstroNvim/astrocommunity/issues/1709)) ([c40ecf8](https://github.com/AstroNvim/astrocommunity/commit/c40ecf888d82138127f9bd585cd6dcb42d5af083))
* **full-dadbod:** fix `blink.cmp` integration ([#1712](https://github.com/AstroNvim/astrocommunity/issues/1712)) ([ab6bf9a](https://github.com/AstroNvim/astrocommunity/commit/ab6bf9a5d5ba3b8e987a44554bb639cb2f467d7c))
* **fyler-nvim:** Refactor options for file explorer configuration ([#1686](https://github.com/AstroNvim/astrocommunity/issues/1686)) ([950f8e6](https://github.com/AstroNvim/astrocommunity/commit/950f8e6984b8448f70ee39f31ee8172ace366aa8))
* **fyler-nvim:** rename deprecated setting  ([#1727](https://github.com/AstroNvim/astrocommunity/issues/1727)) ([8925b98](https://github.com/AstroNvim/astrocommunity/commit/8925b984c79bdf06894d5cdb9decc88012e3be81))
* **fyler:** remove warning about obsolete naming ([8925b98](https://github.com/AstroNvim/astrocommunity/commit/8925b984c79bdf06894d5cdb9decc88012e3be81))
...
* **heirline-vscode-winbar:** add another bit of padding to fix alignment ([129999a](https://github.com/AstroNvim/astrocommunity/commit/129999a6a7a72afaf706d9c4097b1aa83c545941))
...
* **hydra-nvim:** update to maintained repository ([#1694](https://github.com/AstroNvim/astrocommunity/issues/1694)) ([1e6cc53](https://github.com/AstroNvim/astrocommunity/commit/1e6cc538002850c6830da7ec888f0a6099266c12))
...
* **json:** remove `jsonc` parser from Treesitter ([#1700](https://github.com/AstroNvim/astrocommunity/issues/1700)) ([549fd68](https://github.com/AstroNvim/astrocommunity/commit/549fd687ddb17b57240ca145f339b9dfab7b6be3))
...
* **leap-nvim:** migrate to maintained repo ([#1699](https://github.com/AstroNvim/astrocommunity/issues/1699)) ([3c4f762](https://github.com/AstroNvim/astrocommunity/commit/3c4f762b8a149c09139e159b3547a10fe76a9486))
...
* **obsidian-nvim:** remove `util.table_length` ([#1603](https://github.com/AstroNvim/astrocommunity/issues/1603)) ([31346b6](https://github.com/AstroNvim/astrocommunity/commit/31346b6a1cce03651c9dab972623ff78f96dfd3a))
...
* **opencode-nvim:** Fix keybinding commands ([#1731](https://github.com/AstroNvim/astrocommunity/issues/1731)) ([9ee60b5](https://github.com/AstroNvim/astrocommunity/commit/9ee60b5058cfc77d4f0ff6d4a75234a2f4998ee0))
* **opencode-nvim:** missing terminal provider ([#1680](https://github.com/AstroNvim/astrocommunity/issues/1680)) ([2e6c893](https://github.com/AstroNvim/astrocommunity/commit/2e6c893732998b2cd07da64525e4f1834191c3b9))
* **opencode-nvim:** replace obsolete placeholders with newer [@this](https://github.com/this) ([#1725](https://github.com/AstroNvim/astrocommunity/issues/1725)) ([ba62c2f](https://github.com/AstroNvim/astrocommunity/commit/ba62c2fe60feda1af068c226539aaa6a90f229bc))
* **overseer-nvim:** Adjust overseer-nvim command to match v2.0 ([#1729](https://github.com/AstroNvim/astrocommunity/issues/1729)) ([75acbbd](https://github.com/AstroNvim/astrocommunity/commit/75acbbdb8b702c8ad8492ca1a0a9548e9df53ae4))
...
* **pack/python:** Update README to use base pack ([2b889c7](https://github.com/AstroNvim/astrocommunity/commit/2b889c7bcca1b9b7b32e66f0cfe07626e30bf4da))
...
* **rustowl:** fix build failure ([#1695](https://github.com/AstroNvim/astrocommunity/issues/1695)) ([be1df9e](https://github.com/AstroNvim/astrocommunity/commit/be1df9ecc16cbf91e497ad6f1063d73d3b989f66))
...
* **ts-error-translator-nvim:** update ts-error-translator to v2 ([8d16e50](https://github.com/AstroNvim/astrocommunity/commit/8d16e50c840dd1c5b63fd45fc0cbc98f5b56fccc))
...
* **vscode-diff-nvim:** Rename plugin to reflect upstream change in name ([#1720](https://github.com/AstroNvim/astrocommunity/issues/1720)) ([b4eb0b8](https://github.com/AstroNvim/astrocommunity/commit/b4eb0b8d5d102b2c620889b79127dd54db503cf3))
* **vtsls:** adding 'typescript-svelte-plugin' in vtsls globalPlugins ([aa20d45](https://github.com/AstroNvim/astrocommunity/commit/aa20d45d918ba1bf2c5bd183870e0a1ae3d5e636))
